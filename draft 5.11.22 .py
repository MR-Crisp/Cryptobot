            ...
            while not veri:
                ...
                try:        # if the api submits an error, this allows for the user to fix it
                    ...
                    if account.status == 'ACTIVE':
                        ...
                        encrypted = str(encryption(password,data)) # got this nonsense working... idk how but it does...
        ...
        while name_found == False:
                ...
                with open('keys.txt','r', encoding = 'utf-8') as f:
                    ...
                    for line in lines:
                        ...
                        if pos[0] == name:
                            name_found = True
                            password = getpass('Enter your password') #working on this part 
                        else:
                            print('Error account not found. Try again or make an account to continue')
                            return auth()
